# RLVR Demo — archived proof-of-concept

> **Archived.** This directory predates the four training runs now at
> [`../code-rlvr/`](../code-rlvr/), [`../math-rlvr/`](../math-rlvr/),
> [`../gemma-rlvr/`](../gemma-rlvr/), and [`../gemma-rlvr-v2/`](../gemma-rlvr-v2/).
> Kept here for historical reference; superseded in April 2026.
