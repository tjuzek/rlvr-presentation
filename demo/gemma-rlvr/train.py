...
Defaults target Gemma-2-2B-IT with G=8 generations and temperature 1.0 —
the configuration chosen to land inside GRPO's "reward variance" sweet
spot. See ../math-rlvr/ (OLMo-2-7B-Instruct, G=4, temp 0.7) for the
version that landed outside the band and saw no net improvement.
